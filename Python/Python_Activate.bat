...
set INSTALL_PYTHON_VERSION=3.10.6
...
if not "%PYTHON_VERSION_VAR:~7,4%"=="%ACTIVATE_PYTHON_VERSION%" (
	...
	if not exist %PYTHON_DIR%\ (
		...
		echo %CURL_CMD% -o %~dp0env\python.zip https://www.python.org/ftp/python/%INSTALL_PYTHON_VERSION%/python-%INSTALL_PYTHON_VERSION%-embed-amd64.zip
		%CURL_CMD% -o %~dp0env\python.zip https://www.python.org/ftp/python/%INSTALL_PYTHON_VERSION%/python-%INSTALL_PYTHON_VERSION%-embed-amd64.zip
